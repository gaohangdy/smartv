...
const Groups: React.FC = () => {
  ...
  const columns: ProColumns<API.RuleListItem>[] = [
    ...
    {
      title: <FormattedMessage id="pages.security.users.colums.status" defaultMessage="Status" />,
      dataIndex: 'status',
      hideInForm: true,
      valueEnum: {
        0: {
          text: (
            <FormattedMessage id="pages.security.users.nameStatus.enable" defaultMessage="Enable" />
          ),
          status: 'Success',
        },
        1: {
          text: (
            <FormattedMessage
              id="pages.security.users.nameStatus.disable"
    ...
    <PageContainer breadcrumbRender={false}>
      ...
      <ModalForm
        title={intl.formatMessage({
          id: 'pages.security.users.createForm.newRule',
