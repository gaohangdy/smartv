export default {
  'pages.layouts.userLayout.title': 'New experience for your data visualization',
  'pages.login.accountLogin.tab': 'アカウントログイン',
  'pages.login.accountLogin.errorMessage': 'ユーザー名/パスワードが正しくありません(admin/test)',
  'pages.login.success': 'Login successful!',
  'pages.login.username.placeholder': 'ユーザー名：adminまたはuser',
  'pages.login.username.required': 'ユーザー名を入力してください！',
  'pages.login.password.placeholder': 'パスワード：test',
  ...
  'pages.security.users.title': 'ユーザー一覧',
  'pages.security.users.colums.id': 'ログイン名',
  'pages.security.users.colums.name': '名前',
  'pages.security.users.colums.status': 'ステータス',
  'pages.security.users.colums.lastlogin': '最終ログイン日時',

  'pages.security.users.createForm.newRule': '新規ユーザーを作成',

  'pages.security.users.nameStatus.enable': '有効',
  'pages.security.users.nameStatus.disable': '無効',
  ...
  'pages.dashboard.product.label': '新商品提案',
  'pages.dashboard.sales.label': '販売分析',
  'pages.dashboard.history.label': '履歴検索',
  'pages.dashboard.customize.label': 'カスタマイズ',
};
